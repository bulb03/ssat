...
<section class="coach-wrap">
	<div class="reg-wrap">
        ...
        <table class="region-table">
            <colgroup>
                <col class="newstitleA01">
                <col class="newstitleA02">
                <col class="newstitleA03">
                <col class="newstitleA04">
                <col class="newstitleA05">
                <col class="newstitleA06">
                <col class="newstitleA07">
            </colgroup>
            <thead>
                <tr>
            ...
            foreach ($meeting as $row)
            {
                ...
                echo "<tr>";
                echo "<td><a href=\"coach_meeting_revise.php?meetingID=".$row["id"]."\"> ".$row["name"]." </a></td>";
                echo "<td> ".$date_." </td>";
                echo "<td> ".$row["type"]." </td> ";
                echo "<td> ".$row["location"]." </td> ";
                echo "<td><a href = \"javascript:;\" > ".$row["num"]." </a></td> ";
                echo "<td><a href = \"coach_meeting_revise.php?meetingID=".$row["id"]."\" ><input type = \"button\" name = \"login\" value = \"修改\" id = \"updateBtn\" class=\"btn btn-lg region-btn\"/></a></td>";
                echo "<td><a href = \"coach_meeting_delete.php?meetingID=".$row["id"]." \"><input type=\"button\" name=\"deleteBtn\" value=\"刪除\" id=\"deleteBtn\" class=\"btn btn-lg region-btn\"/></a></td>";
                echo "</tr>";
            }
           ?>
            </tbody>
    	...
    	<div class="coach-inblock">
            <form method="Get" action="coach_meeting_add.php">
