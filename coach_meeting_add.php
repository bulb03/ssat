   ...
   <div class="wrapper-login">
    ...
    <div class="reg-wrap">
                ...
                <section class="coach-wrap">
                    <form id="form1" method="POST" action="coach_meeting_add_.php">
                    <p>
                        <label class="label">會議名稱</label>
                        <input type="text" CssClass="btnTxt" placeholder="第一次輔導會議" id="mem_name" name="mem_name">
                    </p>
                    <p>
                        <label class="label">會議類型</label>
                        <div class="coachradiobox">
                            <input type="checkbox" name="type[]" id="type1" value="計畫執行籌備工作會">計畫執行籌備工作會
                            <input type="checkbox" name="type[]" id="type2" value="主聘學校工作協調會">主聘學校工作協調會
                            <input type="checkbox" name="type[]" id="type3" value="區域輔導會議">區域輔導會議
                            <input type="checkbox" name="type[]" id="type4" value="區域醫療網聯絡會議">區域醫療網聯絡會議
                        </div>
                    </p>
                    <p>
                        <label class="label">會議地點</label>
                        <input CssClass="membtn-control btnTxt" type="text" name="location" id="location">
                    </p>
                    <p>
                        <label class="label">會議日期</label>
                        <select id="selRegistBoxYearPage" name="selRegistBoxYearPage" value="(new Date()).getYear()" class="select-stm1 btnTxt">
                        ...
                        <select id="selRegistBoxMonthPage" name="selRegistBoxMonthPage" value="(new Date()).getMonth()" class="select-stm1 btnTxt">
                        ...
                        <select id="selRegistBoxDayPage" name="selRegistBoxDayPage" value="(new Date()).getDate()" class="select-stm1 btnTxt">
                            <option value="01">01</option>
                            <option value="02">02</option>
                            <option value="03">03</option>
                            <option value="04">04</option>
                    ...
                    <p>
                        <label class="label">會議參與人數</label>
                        <input type="text" class="btnTxt" placeholder="" id="mem_num" name="mem_num">
                    </p>
                    <!--<p>
                    ...
                    <div class="coach-inblock">
                        <input type="submit" name="addBtn" value="確認" id="addBtn" class="btn btn-lg region-btn" />
                    </div>
                    </form>
                </section>
