        ...
        <div class="container">
            <div class="regionbox">
                ...
                <section class="coach-wrap">
                    <form id="form1" method="POST" action="coach_edulecturelist_add_.php">
                    <?php echo "<input type=\"hidden\" name=\"uaccid\" value=\"".$_SESSION['regional_id']."\">"; ?>
                    <p>
                        <label class="label">講題</label>
                        <input class="membtn-control btnTxt" type="text" name="topic" id="topic">
                    </p>
                    <p>
                        <label class="label">主講人</label>
                        <input class="membtn-control btnTxt" type="text" name="name" id="name">
                    </p>
                    <p>
                        <label class="label">講座主題類別</label>
                            <input type="checkbox" name="type[]" id="type1" value="運動防護與管理">運動防護與管理
                            <input type="checkbox" name="type[]" id="type2" value="運動訓練與調整">運動訓練與調整
                            <input type="checkbox" name="type[]" id="type3" value="運動營養">運動營養
                            <input type="checkbox" name="type[]" id="type4" value="運動心理">運動心理
                            <input type="checkbox" name="type[]" id="type5" value="運動禁藥">運動禁藥
                            <input type="checkbox" name="type[]" id="type6" value="其他">其他
                    </p>
                    
                  <p>
                        <label class="label">講座日期</label>
                        ...
                        <select id="selRegistBoxMonthPage" name="selRegistBoxMonthPage" class="select-stm1 btnTxt">
                        ...
                        <select id="selRegistBoxDayPage" name="selRegistBoxDayPage" class="select-stm1 btnTxt">
                            <option value="01">01</option><option value="02">02</option><option value="03">03</option>
                        <option value="04">04</option><option value="05">05</option><option value="06">06</option><option value="07">07</option><option value="08">08</option><option value="09">09</option>
                    ...
                    <p>
                        <label class="label">講座地點</label>
                        <input class="membtn-control btnTxt" type="text" name="location" id="location">
                    </p>
                    <p>
                        <label class="label">講座人數</label>
                        <input class="membtn-control btnTxt" type="text" name="mem_num" id="mem_num">
                    </p>
                    

                    
                  <div class="coach-inblock">
                      <input type="submit"name="addBtn" Text="確認" id="addBtn" class="btn btn-lg region-btn" />              
                  </div>                  
                  </form>